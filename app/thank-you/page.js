...
const ThankYouPage = () => {
  ...
  React.useEffect(() => {
    // Use the conversion tracker if available
    if (typeof window !== "undefined" && window.upsaleConversionTracker) {
      window.upsaleConversionTracker.trackLeadConversion("contact_form");
      window.upsaleConversionTracker.trackConversionPageView(
        "Thank You - Lead Generated"
      );
    } else {
      ...
      if (typeof window !== "undefined" && window.gtag) {
        ...
        window.gtag("event", "page_view", {
          page_title: "Thank You - Lead Generated",
