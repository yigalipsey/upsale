...
import articleData from "../../data/articles/why-our-sales-team-is-the-best.json";

const WhyOurSalesTeamIsTheBestPage = () => {
  return (
      ...
      <div className="py-16 px-6 lg:px-24">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-[#001c55] mb-4">
            רוצה שאנשי המכירות שלנו יעבדו בשביל ההצלחה שלך?
          </h2>
          <p className="text-lg text-gray-700 mb-6">
            פנה אלינו עוד היום ותן לצוות המובילים בתעשייה לקחת את העסק שלך לשלב
            הבא.
          </p>
          <a
            href="#contact"
...
export default WhyOurSalesTeamIsTheBestPage;
